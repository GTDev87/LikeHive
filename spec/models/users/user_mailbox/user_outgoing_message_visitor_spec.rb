...
describe UserOutgoingMessageVisitor do  
  describe "visit outgoing messages" do    
    ...
    it "should visit outgoing message" do      
      outgoing_message = Factory.build(:contact_message, message_data: Factory.build(:message_data, :from => @user))
    ...
    it "should not visit not outgoing message" do
      not_outgoing_message = Factory.build(:contact_message, message_data: Factory.build(:message_data, :from => Factory.build(:user)))
    ...
    it "should find all of the outgoing messages" do
      ...
      5.times do
        outgoing_messages << Factory.build(:contact_message, message_data: Factory.build(:message_data, :from => @user))
        message_array << Factory.build(:contact_message, message_data: Factory.build(:message_data, :from => Factory.build(:user)))
      end
